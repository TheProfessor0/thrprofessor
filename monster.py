...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            print " DESTROYER STAFF BY PROFESSOR"
    else:
...
def startgrab():
	...
	p = ThreadPool(30)
	p.map(main, id)
        anime("\x1b[32;1m>>>>>>>>>>>>>>>\x1b[31;1mMonster\x1b[37;1mwa7sh\x1b[32;1m<<<<<<<<<<<<<<<")
